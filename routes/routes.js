...
// const fileController = require('../controllers/imageUpload')
...
router.post('/user', controller.addUser)
  ...
  .post('/deleteuser/:id', controller.deleteUser)
  ...
  .put('/updatejobstatus', controller.updateJobStatus)
  // .post('/upload', fileController.fileUpload)
